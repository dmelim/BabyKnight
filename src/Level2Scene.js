export default class Level2Scene extends Phaser.Scene {
  ...
  create() {
    ...
    this.createPlatform(this.platforms, 50, 300, 200);
    //this.createPlatform(this.platforms, 300, 700, 250);
    this.createPlatform(this.platforms, 500, 1000, 200);
    this.createPlatform(this.platforms, 1101, 800, 200);
    this.createPlatform(this.platforms, 1501, 450, 75);
    this.createPlatform(this.platforms, 1800, 200, 50);

    // Create the red circle sprite with physics
    this.redCircle = this.physics.add.sprite(110, 100, 'redCircle');
    ...
    this.blueBall = this.physics.add.staticSprite(1100, 700, 'blueBall');
    ...
    this.brownSquare = this.physics.add.staticSprite(1800, 150, 'brownSquare');
